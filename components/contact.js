            ...
            <form netlify="true">
              <div className="space-y-4 mt-8 ">
                <input
                  ...
                  className="placeholder:text-gray-600 px-2 py-3 bg-slate-300 w-full text-sm border-b-4 focus:border-red-700 outline-none rounded-md transition-all duration-500 dark:text-black"
                />
                ...
                <textarea
                  ...
                  className="placeholder:text-gray-600 px-2 py-3 bg-slate-300 w-full text-sm border-b-4 focus:border-red-700 outline-none rounded-md transition-all duration-500 h-32 dark:text-black"
                ></textarea>
              </div>
              <button
                type="submit"
