...
let SplideContent = () => {
  ...
  return (
    <Container className="shadow-inner text-center flex flex-wrap justify-start rounded-xl text-gray-800 bg-gray-100 dark:bg-slate-800 dark:text-gray-200 p-12 ">
      <div className="grid lg:grid-cols-2 gap-8 max-lg:max-w-2xl mx-auto p-12">
        ...
        <div className="flex justify-center items-center  shadow-black dark:shadow-sky-900 dark:border-4 dark:border-gray-900 shadow-lg rounded-xl">
