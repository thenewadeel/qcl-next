      ...
      <footer className=" py-8 px-10 ">
        <div className="md:max-w-[50%] mx-auto text-center self-center">
          <Link href="/" className="flex items-center space-x-2 text-2xl font-medium text-stone-950 dark:text-gray-100">
            <Image src="/img/logo.svg" alt="N" width="64" height="64" className="w-24" />
          ...
          <ul className="mt-6">
            <li className="space-x-10">
              <a href="https://facebook.com/quettaclubltd">
                <svg
              ...
              <a href="https://instagram.com/quettaclubltd">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  className="fill-red-700 inline w-10 h-10"
              ...
              <a href="https://twitter.com/quettaclubltd">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  className="fill-red-700 inline w-10 h-10"
        ...
        <ul className="grid max-sm:grid-cols-1 max-lg:grid-cols-3 lg:grid-cols-3 gap-12 mt-16">
          <li className="flex items-center">
            <div className="bg-slate-300 dark:bg-slate-900 h-12  w-12 rounded-full flex items-center justify-center shrink-0">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20px"
                height="20px"
                ...
                className="fill-red-900 dark:fill-gray-200 inline w-8 h-8"
              >
                <path
