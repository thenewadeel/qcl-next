...
export default function Footer() {
  const navigation = ["Blog", "Terms", "Legal"];
    ...
    <div className="relative">
      <footer className=" py-8 px-10 ">
        <div className="md:max-w-[50%] mx-auto text-center self-center">
          ...
          <ul className="mt-6">
            <li className="space-x-10">
              <a href="https://www.facebook.com/quettaclublimited/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  className="hover:shadow-[0_0_7px_3px]  hover:bg-transparent hover:shadow-red-700 dark:hover:shadow-red-900 rounded-md  items-center justify-center transition-all duration-300 stroke-1 stroke-red-700 inline w-10 h-10"
                  viewBox="0 0 24 24"
                >
                  <path
                    fillRule="evenodd"
              ...
              <a href="https://www.instagram.com/quettaclub1891/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  className="hover:shadow-[0_0_7px_3px]  hover:bg-transparent hover:shadow-red-700 dark:hover:shadow-red-900 rounded-md  items-center justify-center transition-all duration-300 stroke-1 stroke-red-700 inline w-10 h-10"
              ...
              {/* <a href="https://youtube.com/quettaclubltd">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  className="fill-red-700 inline w-10 h-10"
                  viewBox="0 0 24 24"
                >
                  <path d="m10 15 5.19-3L10 9v6zm11.56-7.83c.13.47.22 1.1.28 1.9.07.8.1 1.49.1 2.09L22 12c0 2.19-.16 3.8-.44 4.83-.25.9-.83 1.48-1.73 1.73-.47.13-1.33.22-2.65.28-1.3.07-2.49.1-3.59.1L12 19c-4.19 0-6.8-.16-7.83-.44-.9-.25-1.48-.83-1.73-1.73-.13-.47-.22-1.1-.28-1.9-.07-.8-.1-1.49-.1-2.09L2 12c0-2.19.16-3.8.44-4.83.25-.9.83-1.48 1.73-1.73.47-.13 1.33-.22 2.65-.28 1.3-.07 2.49-.1 3.59-.1L12 5c4.19 0 6.8.16 7.83.44.9.25 1.48.83 1.73 1.73z" />
                </svg>
              </a> */}
              <a href="https://twitter.com/clublimited">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  className="hover:shadow-[0_0_7px_3px]  hover:bg-transparent hover:shadow-red-700 dark:hover:shadow-red-900 rounded-md  items-center justify-center transition-all duration-300 stroke-1 stroke-red-700 inline w-10 h-10"
        ...
        <Container>
          ...
          <ul className="grid max-sm:grid-cols-1 max-lg:grid-cols-3 lg:grid-cols-3 gap-12 mt-16">
            <li className="flex items-center">
              <div className="bg-slate-500 bg-opacity-20 dark:bg-slate-500 dark:bg-opacity-10 hover:shadow-[0_0_7px_3px]  hover:bg-transparent hover:shadow-red-700 dark:hover:shadow-red-900 h-12  w-12 rounded-full flex items-center justify-center transition-all duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20px"
                  height="20px"
                  ...
                  className="fill-red-900  inline w-8 h-8"
                >
                  <path
              ...
              <a href="https://wa.me/92812822847" className="dark:text-gray-300 text-sm ml-3">
            ...
            <li className="flex items-center">
              ...
              <a href="mailto:info@quettaclub.org" className="dark:text-gray-300 text-sm ml-3">
            ...
            <li className="flex items-center">
              ...
              <a href="https://maps.app.goo.gl/uf9t2cf8LwLy4EZE7" className="dark:text-gray-300 text-sm ml-3">
          ...
          {/* <div className="md:flex md:item-center">
            ...
            <p className="text-sm text-gray-800 dark:text-gray-300 ml-auto max-md:mt-4">
              Copyright © 1891 - {new Date().getFullYear()} Quetta Club Limited.
            </p>
          </div> */}
        </Container>
      </footer>
