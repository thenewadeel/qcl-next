      ...
      <Container className="flex flex-wrap ">
        <div className="scrollStop w-full md:pt-40 shadow-inner h-screen text-center flex flex-col justify-start bg-[url('/img/user3.jpg')] object-cover bg-fixed bg-cover justify-between">
          ...
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight  self-center text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Quetta Club Ltd
            </h1>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="pt-2 text-gray-400 dark:text-gray-400">A{/* <AmazonLogo /> */}</div>
            <div className="text-gray-400 dark:text-gray-400">B{/* <VerizonLogo /> */}</div>
            <div className="text-gray-400 dark:text-gray-400">C{/* <MicrosoftLogo /> */}</div>
            <div className="pt-1 text-gray-400 dark:text-gray-400">D{/* <NetflixLogo /> */}</div>
            <div className="pt-2 text-gray-400 dark:text-gray-400">E{/* <SonyLogo /> */}</div>
          </div>
        </div>
        XXXXXXXXXXXXXX
      </Container>
